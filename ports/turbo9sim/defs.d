...
_FF_IRQ_POLL   set       0                   Set to 1 for interrupt service routine polling

* Use virtual interrupt service routines using F$VIRQ.
_FF_VIRQ_POLL  set       0                   Set to 1 for virtual interrupt service routine polling

* Wall time gives year/month/date/hour/minute/second support.
_FF_WALLTIME   set       0                   Set to 1 for a software wall time clock

* Module CRC and header parity checks are useful for integrity, but slows down loading.
_FF_MODCHECK   set       0                   Set to 1 for module header and CRC checking

* Unified I/O adds a standard device interface at the expense of more memory.
_FF_UNIFIED_IO set       0                   Set to 1 for unified I/O

* Booting from an external storage device can bring in additional functionality.
_FF_BOOTING    set       0                   Set to 1 for bootfile loading
